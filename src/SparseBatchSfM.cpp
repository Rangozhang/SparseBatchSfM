...
namespace {
  ...
  void SparseBatchSfM::run(const std::string& input_path) {
    ...
    // Homer
    controller->feature_processor_->feature_match(controller->image_seq_, controller->feature_struct_, 800, 200, false);
    /*
    ...
    */
    ...
    // Homer
    controller->feature_processor_->skeletonize(controller->feature_struct_.skeleton, 200);
